...
Plug 'morhetz/gruvbox' " MIT license
...
let g:neoterm_repl_python = ['. .venv/bin/activate && python']
...
let g:coc_global_extensions = ['coc-json', 'coc-pyright', 'coc-yaml', 'coc-todolist', 'coc-toml', 'coc-sh', 'coc-docker'] 
" 'coc-clangd'
" --- Coc ---
